...
const _PRONOUN_ = ["I", "We", "You", "He", "She", "It", "They"];
 ...
 */
const PATTERNS = {
  defaultPattern: ["_ADJECTIVE__PLURALNOUN__VERB__ADVERB_"],
  beautifulFungiOrSpaghetti: [
    "_ADJECTIVE__PLURALNOUN__CONJUNCTION__PLURALNOUN_"
  ],
  amazinglyScaryToy: ["_ADVERB__ADJECTIVE__NOUN_"],
  neitherTrashNorRifle: ["Neither_NOUN_Nor_NOUN_", "Either_NOUN_Or_NOUN_"],
  ...
  wolvesComputeBadly: ["_PLURALNOUN__VERB__ADVERB_"],
  uniteFacilitateAndMerge: ["_VERB__VERB_And_VERB_"],
